...
- Explain not just the steps you took but the decisions you made, including the
  trade-offs.
- Describe alternative paths you considered and actually pursued, but had to
  back out of, and what each taught you.
- Communicate all of that to your stakeholder, not just to me, so they
  understand and have confidence in your work.
- Show evidence that what you built worked, measured against the criteria you
...
1. Create formal requirements documentation defining system business value and
   implementation.
2. Apply agile project management to organize and manage project resources.
3. Develop oral, written, and visual communication for stakeholder engagement.
4. Acquire new technical skills while integrating existing knowledge.
...
You then defend the PRD at your Sprint 01 review:

- Why these KPIs and not others?
- Why these thresholds?
- What did you consider and reject?

AI can write a strong PRD. What it cannot do is defend why these particular
measures are the right ones for your stakeholder's problem.

### Sprints

Each sprint you ship something that can be demoed, your stakeholder gives
...
| Sprint | Defense audience |
|---|---|
| Sprint 01 | Me |
| Sprint 02 | Your stakeholder is present |
| Sprint 03 | Your stakeholder is present |

Sprint 01 is defended to me so you get a practice round before it counts with a
real audience. After that, you are explaining your work to the person who has
something at stake in it.
...
1. Document the constraint. What changed, when, and what it closed off.
